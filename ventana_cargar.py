...
class VentanaCargarTransaccion(QMainWindow):
    def __init__(self, cargar_productos_instance, ventana_cargar_transaccion=None,):
        ...
        self.setWindowTitle("Transacciones Cargos")
    ...
    def cargar_operaciones_guardadas(self):
        ...
        cursor.execute('SELECT numero_operacion, fecha, estado FROM operaciones_guardadas ORDER BY fecha DESC;')
    ...
    def cargar_productos_por_operacion(self, numero_operacion):
        ...
        cursor.execute('SELECT codigo, cantidad FROM operaciones_guardadas WHERE numero_operacion = ?', (numero_operacion,))
...
if __name__ == "__main__":
    ...
    mainwindow = VentanaCargarTransaccion()
    mainwindow.show()
    sys.exit(app.exec_())